...
options.UseSqlServer(builder.Configuration.GetConnectionString("Buliga_Rares_Lab2Context") ?? throw new InvalidOperationException("Connectionstring 'Buliga_Rares_Lab2Context' not found.")));
