...
namespace Buliga_Rares_Lab2.Data
{
    public class Buliga_Rares_Lab2Context : DbContext
    {
        ...
        public DbSet<Buliga_Rares_Lab2.Models.Category> Category { get; set; }

        public DbSet<Buliga_Rares_Lab2.Models.Member> Member { get; set; }

        public DbSet<Buliga_Rares_Lab2.Models.Borrowing> Borrowing { get; set; }
    }
}
